...
import * as coreumCustomparamsV1TxRegistry from "./customparams/v1/tx.registry";
import * as coreumFeemodelV1TxRegistry from "./feemodel/v1/tx.registry";
...
import * as coreumCustomparamsV1TxAmino from "./customparams/v1/tx.amino";
import * as coreumFeemodelV1TxAmino from "./feemodel/v1/tx.amino";
...
export const coreumAminoConverters = {
  ...
  ...coreumCustomparamsV1TxAmino.AminoConverter,
  ...coreumFeemodelV1TxAmino.AminoConverter,
  ...coreumNftV1beta1TxAmino.AminoConverter
};
export const coreumProtoRegistry: ReadonlyArray<[string, GeneratedType]> = [...coreumAssetFtV1TxRegistry.registry, ...coreumAssetNftV1TxRegistry.registry, ...coreumCustomparamsV1TxRegistry.registry, ...coreumFeemodelV1TxRegistry.registry, ...coreumNftV1beta1TxRegistry.registry];
