...
export const QueryTokenUpgradeStatusesRequest = {
  typeUrl: "/coreum.asset.ft.v1.QueryTokenUpgradeStatusesRequest",
  encode(message: QueryTokenUpgradeStatusesRequest, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.denom !== "") {
      writer.uint32(10).string(message.denom);
    }
    return writer;
  },
  decode(input: BinaryReader | Uint8Array, length?: number): QueryTokenUpgradeStatusesRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial(object: Partial<QueryTokenUpgradeStatusesRequest>): QueryTokenUpgradeStatusesRequest {
    const message = createBaseQueryTokenUpgradeStatusesRequest();
    message.denom = object.denom ?? "";
    return message;
  },
...
export const QueryTokenUpgradeStatusesResponse = {
  typeUrl: "/coreum.asset.ft.v1.QueryTokenUpgradeStatusesResponse",
  encode(message: QueryTokenUpgradeStatusesResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.statuses !== undefined) {
      TokenUpgradeStatuses.encode(message.statuses, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input: BinaryReader | Uint8Array, length?: number): QueryTokenUpgradeStatusesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial(object: Partial<QueryTokenUpgradeStatusesResponse>): QueryTokenUpgradeStatusesResponse {
    const message = createBaseQueryTokenUpgradeStatusesResponse();
  ...
  fromAmino(object: QueryTokenUpgradeStatusesResponseAmino): QueryTokenUpgradeStatusesResponse {
    ...
    if (object.statuses !== undefined && object.statuses !== null) {
      message.statuses = TokenUpgradeStatuses.fromAmino(object.statuses);
    }
    return message;
  },
...
export const QueryFrozenBalancesRequest = {
  typeUrl: "/coreum.asset.ft.v1.QueryFrozenBalancesRequest",
  encode(message: QueryFrozenBalancesRequest, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.pagination !== undefined) {
      PageRequest.encode(message.pagination, writer.uint32(10).fork()).ldelim();
    }
    if (message.account !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryFrozenBalancesRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial(object: Partial<QueryFrozenBalancesRequest>): QueryFrozenBalancesRequest {
    const message = createBaseQueryFrozenBalancesRequest();
    message.pagination = object.pagination !== undefined && object.pagination !== null ? PageRequest.fromPartial(object.pagination) : undefined;
    message.account = object.account ?? "";
    return message;
...
export const QueryFrozenBalancesResponse = {
  typeUrl: "/coreum.asset.ft.v1.QueryFrozenBalancesResponse",
  encode(message: QueryFrozenBalancesResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.pagination !== undefined) {
      PageResponse.encode(message.pagination, writer.uint32(10).fork()).ldelim();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryFrozenBalancesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial(object: Partial<QueryFrozenBalancesResponse>): QueryFrozenBalancesResponse {
    const message = createBaseQueryFrozenBalancesResponse();
    message.pagination = object.pagination !== undefined && object.pagination !== null ? PageResponse.fromPartial(object.pagination) : undefined;
...
export const QueryFrozenBalanceRequest = {
  typeUrl: "/coreum.asset.ft.v1.QueryFrozenBalanceRequest",
  encode(message: QueryFrozenBalanceRequest, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.account !== "") {
      writer.uint32(10).string(message.account);
    }
    if (message.denom !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryFrozenBalanceRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial(object: Partial<QueryFrozenBalanceRequest>): QueryFrozenBalanceRequest {
    const message = createBaseQueryFrozenBalanceRequest();
    message.account = object.account ?? "";
    message.denom = object.denom ?? "";
    return message;
...
export const QueryFrozenBalanceResponse = {
  typeUrl: "/coreum.asset.ft.v1.QueryFrozenBalanceResponse",
  encode(message: QueryFrozenBalanceResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.balance !== undefined) {
      Coin.encode(message.balance, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input: BinaryReader | Uint8Array, length?: number): QueryFrozenBalanceResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial(object: Partial<QueryFrozenBalanceResponse>): QueryFrozenBalanceResponse {
    const message = createBaseQueryFrozenBalanceResponse();
...
export const QueryWhitelistedBalancesRequest = {
  typeUrl: "/coreum.asset.ft.v1.QueryWhitelistedBalancesRequest",
  encode(message: QueryWhitelistedBalancesRequest, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.pagination !== undefined) {
      PageRequest.encode(message.pagination, writer.uint32(10).fork()).ldelim();
    }
    if (message.account !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryWhitelistedBalancesRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial(object: Partial<QueryWhitelistedBalancesRequest>): QueryWhitelistedBalancesRequest {
    const message = createBaseQueryWhitelistedBalancesRequest();
    message.pagination = object.pagination !== undefined && object.pagination !== null ? PageRequest.fromPartial(object.pagination) : undefined;
    message.account = object.account ?? "";
    return message;
...
export const QueryWhitelistedBalancesResponse = {
  typeUrl: "/coreum.asset.ft.v1.QueryWhitelistedBalancesResponse",
  encode(message: QueryWhitelistedBalancesResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.pagination !== undefined) {
      PageResponse.encode(message.pagination, writer.uint32(10).fork()).ldelim();
    }
    for (const v of message.balances) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryWhitelistedBalancesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial(object: Partial<QueryWhitelistedBalancesResponse>): QueryWhitelistedBalancesResponse {
    const message = createBaseQueryWhitelistedBalancesResponse();
    message.pagination = object.pagination !== undefined && object.pagination !== null ? PageResponse.fromPartial(object.pagination) : undefined;
    message.balances = object.balances?.map(e => Coin.fromPartial(e)) || [];
    return message;
...
export const QueryWhitelistedBalanceRequest = {
  typeUrl: "/coreum.asset.ft.v1.QueryWhitelistedBalanceRequest",
  encode(message: QueryWhitelistedBalanceRequest, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.account !== "") {
      writer.uint32(10).string(message.account);
    }
    if (message.denom !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryWhitelistedBalanceRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial(object: Partial<QueryWhitelistedBalanceRequest>): QueryWhitelistedBalanceRequest {
    const message = createBaseQueryWhitelistedBalanceRequest();
    message.account = object.account ?? "";
    message.denom = object.denom ?? "";
    return message;
...
export const QueryWhitelistedBalanceResponse = {
  typeUrl: "/coreum.asset.ft.v1.QueryWhitelistedBalanceResponse",
  encode(message: QueryWhitelistedBalanceResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.balance !== undefined) {
      Coin.encode(message.balance, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input: BinaryReader | Uint8Array, length?: number): QueryWhitelistedBalanceResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial(object: Partial<QueryWhitelistedBalanceResponse>): QueryWhitelistedBalanceResponse {
    const message = createBaseQueryWhitelistedBalanceResponse();
    message.balance = object.balance !== undefined && object.balance !== null ? Coin.fromPartial(object.balance) : undefined;
    return message;
  },
