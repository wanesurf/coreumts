...
export const createLCDClient = async ({
  ...
  return {
    coreum: {
      asset: {
        ft: {
          v1: new (await import("./asset/ft/v1/query.lcd")).LCDQueryClient({
            requestClient
          })
        },
        nft: {
          v1: new (await import("./asset/nft/v1/query.lcd")).LCDQueryClient({
            requestClient
          })
        }
      },
      customparams: {
        v1: new (await import("./customparams/v1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      feemodel: {
        v1: new (await import("./feemodel/v1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      nft: {
