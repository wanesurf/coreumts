...
// @generated from file coreum/nft/v1beta1/event.proto (package coreum.nft.v1beta1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message coreum.nft.v1beta1.EventSend
 */
export class EventSend extends Message<EventSend> {
  ...
  static readonly typeName = "coreum.nft.v1beta1.EventSend";
 ...
 *
 * @generated from message coreum.nft.v1beta1.EventMint
 */
export class EventMint extends Message<EventMint> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "coreum.nft.v1beta1.EventMint";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "class_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message coreum.nft.v1beta1.EventBurn
 */
export class EventBurn extends Message<EventBurn> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "coreum.nft.v1beta1.EventBurn";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "class_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "owner", kind: "scalar", T: 9 /* ScalarType.STRING */ },
