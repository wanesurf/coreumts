...
// @generated from file coreum/nft/v1beta1/genesis.proto (package coreum.nft.v1beta1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message coreum.nft.v1beta1.GenesisState
 */
export class GenesisState extends Message<GenesisState> {
  ...
  /**
   * @generated from field: repeated coreum.nft.v1beta1.Entry entries = 2;
   */
  entries: Entry[] = [];
  ...
  static readonly typeName = "coreum.nft.v1beta1.GenesisState";
 ...
 *
 * @generated from message coreum.nft.v1beta1.Entry
 */
export class Entry extends Message<Entry> {
   ...
   *
   * @generated from field: repeated coreum.nft.v1beta1.NFT nfts = 2;
   */
  nfts: NFT[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "coreum.nft.v1beta1.Entry";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
